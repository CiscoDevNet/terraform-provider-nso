...
type providerData struct {
	...
	Instances  []providerDataInstance `tfsdk:"instances"`
}

type providerDataInstance struct {
...
func (p *provider) Configure(ctx context.Context, req tfsdk.ConfigureProviderRequest, resp *tfsdk.ConfigureProviderResponse) {
	...
	if config.URL.Null {
		...
		if url == "" && len(config.Instances) > 0 {
			url = config.Instances[0].URL.Value
		}
	} else {
	...
	for _, instance := range config.Instances {
		c, err := restconf.NewClient(instance.URL.Value, username, password, insecure, restconf.MaxRetries(int(retries)))
		if err != nil {
			resp.Diagnostics.AddError(
				"Unable to create client",
				"Unable to create restconf client:\n\n"+err.Error(),
...
func (p *provider) GetResources(ctx context.Context) (map[string]tfsdk.ResourceType, diag.Diagnostics) {
	return map[string]tfsdk.ResourceType{
		"nso_restconf":                                            resourceRestconfType{},
		"nso_device_config":                                       resourceDeviceConfigType{},
		"nso_device":     resourceDeviceType{},
		"nso_device_group":     resourceDeviceGroupType{},
	}, nil
}

func (p *provider) GetDataSources(ctx context.Context) (map[string]tfsdk.DataSourceType, diag.Diagnostics) {
	return map[string]tfsdk.DataSourceType{
		"nso_restconf":                                            dataSourceRestconfType{},
		"nso_device_config":                                       dataSourceDeviceConfigType{},
		"nso_device":     dataSourceDeviceType{},
		"nso_device_group":     dataSourceDeviceGroupType{},
	}, nil
}
